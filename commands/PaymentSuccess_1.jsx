...
export default function PaymentSuccess({
  ...
  const [checkDash,   setCheckDash]   = useState(60);
  ...
  useEffect(() => {
    if (prefersReduced) {
      setPhase(5); setCircleDash(0); setCheckDash(0);
      setCardVisible(true); setBtnVisible(true);
      return;
    }
    const t = [];
    ...
    <>
      ...
      <div className="ps-wrap" style={{
        ...
        <div style={{ position: "relative", marginBottom: "1.6rem" }}>
          ...
          {/* pulse rings */}
          {phase >= 3 && <>
            <div className="ps-pulse1" style={{
              position: "absolute", inset: 0, borderRadius: "50%",
              border: "2px solid rgba(34,197,94,0.55)",
              pointerEvents: "none",
            }} />
            <div className="ps-pulse2" style={{
              position: "absolute", inset: 0, borderRadius: "50%",
          ...
          <svg width="120" height="120" viewBox="0 0 120 120"
            ...
            <circle cx="60" cy="60" r={CIRCLE_R} fill="none"
              stroke="rgba(34,197,94,0.12)" strokeWidth="5" />
            <circle cx="60" cy="60" r={CIRCLE_R} fill="none"
              stroke="#22c55e" strokeWidth="5" strokeLinecap="round"
              strokeDasharray={CIRCLE_C} strokeDashoffset={circleDash}
            ...
            />
            <polyline points="36,62 52,78 84,44"
        ...
        <div style={{
          ...
          <span style={{ fontSize: "1.4rem", fontWeight: 700, color: "#4a5fc1" }}>₹</span>
          <span className="ps-amount" style={{
        ...
        <div style={{
          ...
          <svg width="15" height="15" viewBox="0 0 16 16">
            ...
            <polyline points="4,8 7,11 12,5" fill="none"
        ...
        <div style={{
          ...
          <div className="ps-row">
            ...
            <span className="ps-row-val">{dateStr} · {timeStr}</span>
          </div>
          <div className="ps-row">
            <span className="ps-row-label">Payment ID</span>
            <span className="ps-row-val" style={{ display:"flex", alignItems:"center" }}>
              <span style={{
                fontFamily: "'DM Mono', 'Courier New', monospace",
                fontSize: "0.76rem",
              }}>
                {paymentId.length > 18 ? paymentId.slice(0, 18) + "…" : paymentId}
              </span>
